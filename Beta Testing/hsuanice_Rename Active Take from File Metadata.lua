...
@changelog
  v0.13.6 - Fix: tokens immediately before "_" were swallowed; treat "_" as a separator in parser.
  v0.13.5 - UI: consolidated buttons; copy sections revised; label "Copy metadata" (no "(left)"); general polish.
  v0.13.0 - Baseline ("GUI OK"): caret insert, token-boundary snap, cached preview, copy/export, Undo/Redo.
--]]
