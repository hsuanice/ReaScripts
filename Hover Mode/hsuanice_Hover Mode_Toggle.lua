...
@changelog
  v1.0 - Initial release with ExtState and sync support.
--]]
...
local synced_toggle_commands = {
  "Paste Action Command ID here", -- ex. TJF Hover Mode Toggle
  "Paste Action Command ID here", -- ex. LKC HOVER EDIT Toggle
}
